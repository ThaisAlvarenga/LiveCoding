...
// a in this case is just a variable that you pass in the function
// (a)=>a.colorama in here whatever this outputs, we place it back in as variable a
...
// for mac you need to allow hydra to use the camera
//solid backgrounds in the camera are the ones that work best
s0.initCam()
...
gradient(0.1).((a)=>a.colorama(.01)).out()
...
//this is all setup code, you don't have to do it again just once in your code.
DD=0.01
...
// try to put this palete  https://coolors.co/palette/cdb4db-ffc8dd-ffafcc-bde0fe-a2d2ff
