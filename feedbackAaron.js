noise(1,2,3)
osc(20,()=>cc[0]).color(10,()=>time,150).out()
...
p5.remove() // need to initialize again
...
// add more color in
src(o0).scale(1.01).blend(o1,.1).add(o1, 0.1).out(o0)

render(o0)

// scroll x
src(o0).scale(1.01).rotate(0.01).scrollX(0.01).blend(o1,.05).add(o1, 0.1).out(o0)

// layer with luma is more crisp
src(o0).scale(1.01).rotate(0.01).layer(src(o1).luma(0.08)).out(o0)

// modulate
src(o0).modulate(src(o0).scale(1.01), 0.01).blend(o1,.1).out(o0)

// modulate hue (with larger modulate value) to make the modulation centered
